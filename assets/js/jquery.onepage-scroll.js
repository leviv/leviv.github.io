  ...
  $.fn.onepage_scroll = function(options){
      ...
      // Just a simple edit that makes use of modernizr to detect an IE8 browser and changes the transform method into
        ...
        if (settings.direction == 'horizontal') {
         ...
         "transition": "all " + settings.animationTime + "ms " + settings.easing
            ...
            if (drone_pos == 1){
                $("#floating-ar").animate({"width": "100%", "left": "0", "top": "40%"},800); 
            } else if (drone_pos == 2){
                $("#floating-ar").animate({"width": "200px", "left": "7%", "top": "3%"},800); 
            } else if (drone_pos == 3){
                $("#floating-ar").animate({"width": "200px", "left": "83%", "top": "3%"},800);
            } else if (drone_pos == 4){
                $("#floating-ar").animate({"width": "200px", "left": "7%", "top": "3%"},800); 
            } else if (drone_pos == 5){
                $("#floating-ar").animate({"width": "200px", "left": "83%", "top": "3%"},800);
    ...
    if(settings.pagination == true)  {
      $(".onepage-pagination li a").click(function (){
        ...
        /*
        CODE TO GET THE LINKS ON THE DRONE PAGE WORKING ADDED IN BY LEVI VILLARREAL
        */
